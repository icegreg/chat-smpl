...
func (c *chatServiceClient) SyncMessages(ctx context.Context, in *SyncMessagesRequest, opts ...grpc.CallOption) (*SyncMessagesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.ChatService/SyncMessages", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) ForwardMessage(ctx context.Context, in *ForwardMessageRequest, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/chat.ChatService/ForwardMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) SendTyping(ctx context.Context, in *SendTypingRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/chat.ChatService/SendTyping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ChatService_SyncMessages_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/SyncMessages",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatService_ForwardMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/ForwardMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ChatService_SendTyping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.ChatService/SendTyping",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
